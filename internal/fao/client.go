...
// DownloadResult holds a fetched FAO bulk file and HTTP metadata.
...
// Client downloads files from FAO FAOSTAT bulk endpoints.
type Client struct {
...
// NewClient creates a FAO HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated FAO bulk URL.
