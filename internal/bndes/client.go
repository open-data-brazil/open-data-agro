...
// Client downloads files from the BNDES open data portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates a BNDES HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated BNDES portal URL.
