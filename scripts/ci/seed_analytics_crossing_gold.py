        ...
        pa.table(
            {
                ...
                "ano": ["2023"] * 4 + ["2024"] * 4,
                "capturado_em": [ingested] * 8,
                "fonte_oficial": [fonte] * 8,
                "_dataset_id": ["cepea.soja-paranagua"] * 8,
                "_source_file": ["seed.parquet"] * 8,
            }
        ),
    )
        ...
        pa.table(
            {
                ...
                "ano": ["2023"] * 4 + ["2024"] * 5,
                "capturado_em": [ingested] * 9,
                "fonte_oficial": [fonte] * 9,
                "_dataset_id": ["bcb.sgs-ptax-usd-venda"] * 9,
                "_source_file": ["seed.parquet"] * 9,
            }
        ),
    )
