...
// DownloadResult holds a fetched BCB API payload and HTTP metadata.
...
// Client downloads files from the BCB SGS API.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates a BCB HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated BCB API URL.
