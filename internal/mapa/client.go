...
// Client downloads files from the MAPA open data portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates a MAPA HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated MAPA portal URL.
