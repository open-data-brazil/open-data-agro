...
def main() -> int:
    ...
    if args.suite:
        ...
        mapping = {
            ...
            "bronze_abiove_balanco_complexo_soja": "expectations/suites/bronze/abiove/balanco_complexo_soja.json",
            "bronze_abiove_exportacoes_complexo_soja": "expectations/suites/bronze/abiove/exportacoes_complexo_soja.json",
            "bronze_abiove_capacidade_instalada_esmagamento": "expectations/suites/bronze/abiove/capacidade_instalada_esmagamento.json",
            ...
            "bronze_b3_futuro_cafe": "expectations/suites/bronze/b3/futuro_cafe.json",
            "bronze_b3_futuro_acucar": "expectations/suites/bronze/b3/futuro_acucar.json",
