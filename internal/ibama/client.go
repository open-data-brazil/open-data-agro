...
// Client downloads files from the IBAMA open data portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates an IBAMA HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated IBAMA portal URL.
