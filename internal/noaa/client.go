...
// Client downloads files from NOAA CPC/NCEI endpoints.
type Client struct {
...
// DownloadResult holds a fetched NOAA file and HTTP metadata.
...
// NewClient creates a NOAA HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated NOAA URL.
