...
mkdir -p "$LAKE_ABS/gold/mart_conab__estimativa_cafe"
mkdir -p "$LAKE_ABS/gold/mart_conab__serie_historica_cafe"
mkdir -p "$LAKE_ABS/gold/mart_conab__custo_producao"
...
mkdir -p "$LAKE_ABS/gold/mart_conab__prohort_diario"
mkdir -p "$LAKE_ABS/gold/mart_conab__prohort_mensal"
mkdir -p "$LAKE_ABS/gold/mart_conab__estoques_publicos"
mkdir -p "$LAKE_ABS/gold/mart_conab__operacoes_comercializacao"
mkdir -p "$LAKE_ABS/gold/mart_conab__vendas_balcao"
...
mkdir -p "$LAKE_ABS/gold/mart_conab__frete"
mkdir -p "$LAKE_ABS/gold/mart_conab__capacidade_estatica"
...
mkdir -p "$LAKE_ABS/gold/mart_inmet__estacoes_automaticas"
mkdir -p "$LAKE_ABS/gold/mart_inmet__estacoes_convencionais"
mkdir -p "$LAKE_ABS/gold/mart_inmet__bdmep_diario"
mkdir -p "$LAKE_ABS/gold/mart_inmet__bdmep_mensal"
mkdir -p "$LAKE_ABS/gold/mart_inmet__pacote_anual_automaticas"
...
mkdir -p "$LAKE_ABS/gold/mart_cross__soja_features_monthly"
