...
const defaultCKANPackageShowURL = "https://dadosabertos.bndes.gov.br/api/3/action/package_show"
...
// ResolveURL returns the latest CKAN resource download URL for a BNDES catalog entry.
