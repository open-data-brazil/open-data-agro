...
// DownloadResult holds a fetched DNIT open-data file and HTTP metadata.
...
// Client downloads files from the DNIT open data portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates a DNIT HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated DNIT portal URL.
