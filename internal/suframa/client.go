...
// DownloadResult holds a fetched SUFRAMA file and HTTP metadata.
...
// Client downloads files from the SUFRAMA open data portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates a SUFRAMA HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated SUFRAMA portal URL.
