...
// Client downloads files from the ANP portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates an ANP HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated ANP portal URL.
