...
// Client downloads files from the ANTT open data portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates an ANTT HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated ANTT portal URL.
