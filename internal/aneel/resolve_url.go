...
const defaultCKANPackageShowURL = "https://dadosabertos.aneel.gov.br/api/3/action/package_show"
...
// ResolveURL returns the latest CKAN resource download URL for an ANEEL catalog entry.
