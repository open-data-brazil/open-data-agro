...
// DownloadResult holds a fetched portal file and HTTP metadata.
...
// Client downloads files from the ANEEL open data portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates an ANEEL HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated ANEEL portal URL.
