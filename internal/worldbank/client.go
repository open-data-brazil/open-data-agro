...
// DownloadResult holds a fetched World Bank file and HTTP metadata.
...
// Client downloads files from World Bank commodity markets endpoints.
type Client struct {
...
// NewClient creates a World Bank HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated World Bank URL.
