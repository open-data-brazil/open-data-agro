...
// Client downloads files from the CONAB portal.
type Client struct {
	httpClient *http.Client
	maxRetries int
}

// NewClient creates a CONAB HTTP client with retry and timeout defaults.
...
// Download fetches bytes from a validated CONAB portal URL.
